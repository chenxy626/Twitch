...
public class RecommendationService {
    ...
    private static final int DEFAULT_PER_GAME_RECOMMENDATION_LIMIT = 10; //每个游戏返回10个
    private static final int DEFAULT_TOTAL_RECOMMENDATION_LIMIT = 20; //每个类型返回20个
    ...
    private List<Item> recommendByFavoriteHistory(Set<String> favoritedItemIds, List<String> favoriteGameIds, ItemType type) throws RecommendationException {
        ...
        if (sortedFavoriteGameIdListByCount.size() > DEFAULT_GAME_LIMIT) {
            sortedFavoriteGameIdListByCount = sortedFavoriteGameIdListByCount.subList(0, DEFAULT_GAME_LIMIT); //取从0-3的前三个
        }
